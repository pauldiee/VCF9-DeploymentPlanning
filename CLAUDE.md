...
| `docs/21-config-artifacts.md`    | Reverse of the workbook flow — capture re-submittable spec JSON from a **built** instance (bring-up spec, Fleet LCM component specs, Supervisor export, NSX policy hierarchy), sanitise/parameterise/validate into templates. Phase 1 (doc); `tools/Get-VCFDeploymentArtifacts.ps1` is the Phase-2 script (#295) |
