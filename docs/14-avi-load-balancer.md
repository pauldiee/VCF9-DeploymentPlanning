...
Once the VS is up, the Pattern 3 hardening around it — the **Transit Gateway
gateway firewall**, the **NSX DFW exclusion-list** sequence for the Service
Engines, **IP-based portal locking** (Avi HTTP policies), the **WAF policy**,
and the **Avi management-plane** Tier-1 firewall — is a guide of its own:
[`19-securing-vcf-automation.md`](19-securing-vcf-automation.md). It follows
Broadcom's *Securing VCF Automation Deployment* design page and layers straight
onto the VS built above.
