...
| `docs/27-vcf-operations-ha-cloud-proxy-vvf.md` | Build guide — deploying VCF Operations itself in VVF/standalone: node OVA deploy, setup wizard, enabling HA (inline or Day-N), and deploying/registering a Cloud Proxy. Precedes docs/26 |
